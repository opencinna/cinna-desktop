...
import type { NoteFolderData } from '../../../../shared/notes'
import { useUpdateNoteFolder } from '../../hooks/useNotes'

interface NoteFolderEditModalProps {
  folder: NoteFolderData
  onClose: () => void
}

export function NoteFolderEditModal({
  folder,
  onClose
}: NoteFolderEditModalProps): React.JSX.Element {

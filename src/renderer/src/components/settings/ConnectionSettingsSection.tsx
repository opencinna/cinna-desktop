        ...
        <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-bg)] p-4">
          <div className="flex items-center gap-3">
            <div className="flex-1">
              <div className="text-[14px] font-medium text-[var(--color-text)]">Re-authenticate</div>
              ...
              {reauthError && (
                <div className="text-[13px] text-[var(--color-danger)] mt-1.5">{reauthError}</div>
              )}
            </div>
            <button
              type="button"
              ...
              className={`shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-md text-[14px] font-medium

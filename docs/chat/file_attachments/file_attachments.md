...
- Explicitly clearing a draft invalidates pending upload results. Destination changes or loading never silently delete queued files; incompatible files block sending with an explanation.

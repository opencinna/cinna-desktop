...
- A remote budget ending preserves partial text and records a budget pause. It is not task completion. Budget, inflight and uncertain saved sessions refuse another kickoff; inspect the session in Claude and use a new chat where required. Restart does not replay permission answers or automatically recover unfinished remote work.

...
- CLI Update preserves unanswered/declined setup and shared host consent. It performs no Agents Home preparation, workspace setup or account-token work. An existing ready context is refreshed after success; a failure there requires toolchain attention. **Set up** and **Repair** remain Profile actions.

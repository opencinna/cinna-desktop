...
- This is explicit delegation and one-turn continuation. Autonomous multi-turn execution, coordinator handback, budgets, scripts and attach/replay remain later runtime work.
